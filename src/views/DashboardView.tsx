                  ...
                  <div className="min-w-0 flex-auto space-y-2">
                    <div className="mb-2">
                      { isManager(project.manager, user._id) ? 
                        <p className="text-blue-700 uppercase text-md font-light bg-blue-50 border-2 border-blue-500 rounded-lg inline-block  py-1 px-5">Manager</p> :
                        <p className="text-violet-700 uppercase text-md font-light bg-violet-50 border-2 border-violet-500 rounded-lg inline-block py-1 px-5">Colabolador del Equipo</p>
                      }
                    </div>
                    <Link
