...
export default function NavMenu({name}: NavMenuProps) {
  ...
  const logout = () => {
    localStorage.removeItem('AUTH_TOKEN')//Elimino el token del usuario para poder cerrar sesion
    queryClient.invalidateQueries({queryKey:['user']})//Invalido el query del usuario para tambien cerrar sesion
  }
